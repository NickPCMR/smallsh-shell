This program was written in C to demonstrate operating system fundamentals. Smallsh emulates the linux shell by using the Unix process API to make system calls, handle signals and start/stop processes.
